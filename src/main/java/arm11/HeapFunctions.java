...
public class HeapFunctions {
  public static InstructionList freePair(DataInstructions data) {
    ...
    list.add(InstructionFactory.createLabel(new Label("p_free_pair")))
        ...
        .add(InstructionFactory.createCompare(ARM11Registers.R0, new Immediate(0L)))
        ...
        .add(InstructionFactory.createLoad(ARM11Registers.R0, ARM11Registers.SP))
        .add(InstructionFactory.createBranchLink(new Label("free")))
        .add(InstructionFactory.createLoad(ARM11Registers.R0, ARM11Registers.R0, 4L))
